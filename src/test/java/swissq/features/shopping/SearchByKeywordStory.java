...
import swissq.questions.TheSearchResults;
import swissq.tasks.OpenTheApplication;
import swissq.tasks.Search;
...
public class SearchByKeywordStory {
    ...
    public void search_results_should_show_the_search_term_in_the_title() {
        ...
        when(roger).attemptsTo(Search.forTheProduct("iPhone"));

        then(roger).should(eventually(seeThat(TheSearchResults.visibility(), is(true))));
    }
}